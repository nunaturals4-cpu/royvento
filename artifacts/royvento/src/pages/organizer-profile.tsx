            ...
            <section>
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-2">
                {e.galleryImages!.map((src, i) => (
                  <div key={i} className="group relative aspect-square overflow-hidden rounded-xl bg-white/5 border border-white/8">
                    <img src={src} alt={`Gallery photo ${i + 1}`} loading="lazy" className="h-full w-full object-cover group-hover:scale-105 transition-transform duration-500" />
